...
public class BookAndDeleteRes {
	...
	public void user_is_redirected() {
		assert driver.getCurrentUrl().equals("http://localhost:5001/api/airport-results?departureCity=Houston&departureState=TX&radius=30&arrivalCity=Los+Angeles&arrivalState=CA&destination-radius=30");
	};
	...
	public void user_has_flights_displayed() {
		assert driver.getCurrentUrl().equals("http://localhost:5001/api/search-results?originLocationCode=IAH&destinationLocationCode=LAX&departureDate=2021-07-27&returnDate=2021-07-30&adults=2&nonStop=false&travelClass=ECONOMY&maxPrice=400");
	};
	...
	public void user_redirected_to_checkout() {
		assert driver.getCurrentUrl().equals("http://localhost:5001/api/price-results?flightSelection=0");
	};
