...
public class UserServiceTest {
    ...
    public HashMap<Integer, User> dummyUser;
    ...
    public void beforeClassSetUp(){
        ...
        dummyUser = new HashMap<>();

        dummyUser.put(1, new User(1, "Chris", "Sal",
                "heybabe@laker.com","loyal321"));

        String dummyEmail = "heybabe@laker.com";
        String dummyPassword = "loyal321";

        Mockito.when(userDaoImpl.userLogin(dummyEmail,dummyPassword)).thenReturn(dummyUser);
    }
    ...
    public void testUserLogin(){
        ...
        Map<Integer, User> retrievedUser = userServiceImpl.userLogIn(emailTest,passwordTest);
        Assert.assertEquals(retrievedUser.get(1).getId(),1);
        Assert.assertEquals(retrievedUser.get(1).getFirstName(),"Chris");
        Assert.assertEquals(retrievedUser.get(1).getLastName(),"Sal");
        Assert.assertEquals(retrievedUser.get(1).getEmail(),"heybabe@laker.com");
        Assert.assertEquals(retrievedUser.get(1).getPassword(),"loyal321");
    }
